...
public class ComparaJogos {
	...
	public ComparaJogos(Carta[] jogador1_mao, Carta[] jogador2_mao, Carta[] Mesa) { // Construtor da classe ComparaJogos, são construidas duas novas maos, desta vez incluindo as cartas da mesa
	...
	public Carta[] determinaVencedor() {
		...
		if (jogador1_jogos.determinaMelhorMao() > jogador2_jogos
				.determinaMelhorMao()) {

			return jogador1_mao;

		} else if (jogador1_jogos.determinaMelhorMao() < jogador2_jogos
				.determinaMelhorMao()) {
